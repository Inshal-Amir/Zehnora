...
ZEHNORA_DATABASE_URL=postgresql+psycopg://zehnora_platform:$(cat "$S/pg_platform_password")@postgres:5432/zehnora_platform
ZEHNORA_LITELLM_MASTER_KEY=$(cat "$S/litellm_master_key")
