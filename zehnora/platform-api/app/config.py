...
class Settings(BaseSettings):
    model_config = SettingsConfigDict(env_prefix="ZEHNORA_", env_file=".env", extra="ignore")

    # Profile label shown in /platform/v1/health and the portal: "mock", "dev-local-4b" or "gpu".
    profile: str = "mock"

    database_url: str = "postgresql+psycopg://zehnora_platform:change-me@127.0.0.1:5433/zehnora_platform"
