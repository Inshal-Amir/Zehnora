...
- **No per-action approval in LibreChat v0.8.7.** Sending email, sharing and invitations are disabled in the Google connector; general shell commands go through Zehnora's own approval window instead.
