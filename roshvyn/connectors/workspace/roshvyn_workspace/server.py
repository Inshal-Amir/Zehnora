"""Roshvyn workspace MCP server (runs on the client machine; never exposed publicly).
...
def main() -> None:
    print(f"roshvyn-workspace MCP serving {workspace_root()}", file=sys.stderr)
    mcp.run()
