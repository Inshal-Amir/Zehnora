  ...
  return (
    <div className="playground">
      <aside className="conv-list">
        ...
        <p className="muted small">Playground history is stored in your Roshvyn account (PostgreSQL). It is separate from Roshvyn Desktop chats.</p>
      </aside>
      <section className="chat">
        <div className="messages">
          {messages.length === 0 && <div className="muted center">Ask roshvyn-coder something. Each message uses your credits.</div>}
          {messages.map((m) => (
        ...
        <form className="composer" onSubmit={send}>
          <textarea value={text} onChange={(e) => setText(e.target.value)} placeholder="Message roshvyn-coder" rows={2}
