<#
.SYNOPSIS
  Roshvyn GPU PC preflight (Windows PowerShell). Inspects Windows, GPU/driver, WSL2, Docker Desktop, disk, RAM and ports.
  Makes no changes. Run in a normal (non-admin) PowerShell window:
    powershell -ExecutionPolicy Bypass -File roshvyn\scripts\windows\Preflight.ps1
...
# Ports used by the Roshvyn server profile (nginx on 127.0.0.1:8080)
